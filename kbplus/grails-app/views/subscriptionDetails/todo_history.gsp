<div class="container" data-theme="subscriptions">
	<div class="row">
		<div class="col s12">
			...
			<p class="form-caption flow-text text-grey">Subscription Pending Changes History</p>
			<div class="row">
				<div class="col s12">
    		...
    		<div class="pagination" id="todoHistoryPaginate">
				<g:paginate action="todo_history" controller="subscriptionDetails" params="${params}" next="chevron_right" prev="chevron_left" max="${max}" total="${todoHistoryLinesTotal}" />
			</div>
