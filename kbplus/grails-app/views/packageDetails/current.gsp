      ...
      <div class="container">
        ...
        <div class="page-header">
          ...
          <h1><g:if test="${editable}"><span id="packageNameEdit"
            ...
            <g:if test="${feature_zendesk && ( forum_url != null ) }">
    ...
    <div class="container">
            ...
            <g:each in="${titlesList}" var="t">
              ...
              <tr>
                ...
                <td style="vertical-align:top;">
                   ...
                   <g:link controller="tipp" action="show" params="${params.defaultInstShortcode?[defaultInstShortcode:params.defaultInstShortcode]:[]}" id="${t.id}">(TIPP)</g:link><br/>
        ...
        <g:form controller="ajax" action="addToCollection">
          <fieldset>
            ...
            <span class="help-block"></span>
            <button type="submit" class="btn"><i class="material-icons">add_circle_outline</i> Add Title </button>
          </fieldset>
        </g:form>
