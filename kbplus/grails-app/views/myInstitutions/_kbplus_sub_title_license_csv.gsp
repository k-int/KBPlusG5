<g:set var="cfg" value="${[[col:'SubscriptionID', value:{s, ctx -> s.id } ],
					       ...
					       [col:'AssociatedLicenceId', value:{s, ctx -> s.owner?.id }],
						   [col:'LicenceName', value:{s, ctx -> raw(s.owner?.reference) }],
						   [col:'LicenceNoticePeriod', value:{s, ctx -> s.owner?.noticePeriod }],
						   [col:'LicenceURL', value:{s, ctx -> raw(s.owner?.licenseUrl) }],
						   [col:'LicensorRef', value:{s, ctx -> raw(s.owner?.licensorRef) }],
						   [col:'LicenseeRef', value:{s, ctx -> raw(s.owner?.licenseeRef) }]
