...
class PropertyDefinition {
    ...
    @Transient
    static def validTypes = ["Number":Integer.class.name, 
                             "Text":String.class.name, 
                             "Refdata":RefdataValue.class.name, 
                             "Decimal":BigDecimal.class.name]
    ...
    **/
    private static CustomProperty createPropertyValue(owner, PropertyDefinition type) {
        ...
        log.debug("Created new instance of ${ownerClassName} with ID ${newProp.id}");
        newProp
    }
