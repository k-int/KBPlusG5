...
class CostItem {
    ...
    Double costInBillingCurrencyExVAT   //The actual amount - new cost ex tax
    Double taxInBillingCurrency         //Tax on actual amount
    Double costInBillingCurrencyIncVAT  //The actual amount - New cost including tax
    Double costInLocalCurrencyExVAT     //local amount entered or calculated using temp field currency exchange in create
    Double taxInLocalCurrency           //Tax on local amount
    Double costInLocalCurrencyIncVAT    //The local amount - New cost including tax
    ...
    static mapping = {
        ...
        costInBillingCurrencyExVAT column: 'ci_cost_in_billing_currency_ex_vat'
        taxInBillingCurrency column: 'ci_tax_in_billing_currency'
      costInBillingCurrencyIncVAT column: 'ci_cost_in_billing_currency_inc_vat'
      costInLocalCurrencyExVAT column: 'ci_cost_in_local_currency_ex_vat'
        taxInLocalCurrency column: 'ci_tax_in_local_currency'
      costInLocalCurrencyIncVAT column: 'ci_cost_in_local_currency_inc_vat'
    ...
    static constraints = {
        ...
        costInBillingCurrencyExVAT(nullable: true, blank: false)
        taxInBillingCurrency(nullable: true, blank: false)
      costInBillingCurrencyIncVAT(nullable: true, blank: false)
      costInLocalCurrencyExVAT(nullable: true, blank: false)
        taxInLocalCurrency(nullable: true, blank: false)
      costInLocalCurrencyIncVAT(nullable: true, blank: false)
	...
	def getBudgetcodesAsRefDataValues() {
		return CostItemGroup.findAllByCostItem(this).collect {
			[id:it.budgetcode.id, value:it.budgetcode.value]
		}
	}
